...
# library directory
set search_path [list "/usr/local/tools/PDK/ASAP7/asap7libs_24/db"]
...
echo ">>>>> top_level: $top_level, netlist_name: $netlist_name"
...
if {![find design $top_level]} {
  echo "Error: top level $top_level not found in netlist!"
  exit
}
