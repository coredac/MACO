"""Top-level MACO entrypoint — single-iteration four-stage flow.

Wires the four MACO agents (Sec. III): CGRA Co-designer → CGRA Fixer →
Coarse-grained Judge → ConfidenceAdaptiveSelector (Fine-grained Judge + EDA).
"""
...
from confidence_adaptive_selector import ConfidenceAdaptiveSelector  # used by the DC-tools-gated final selection below
...
# This stage needs DC tools — enable when running on a host with Synopsys DC.
